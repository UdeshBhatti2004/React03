      ...
      <div className="main h-auto  w-full ">
         ...
         <div className="image  flex justify-center"> 
          <img
            ...
            className="h-[100vh] w-full object-contain mt-5" 
            alt="Home Service"
          />
        </div>

 
        <div className="elements grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 px-[80px] mt-24">
          ...
          <div className="element-3 flex flex-col items-center text-center">
            ...
            <h1 className="text-black mt-5  roboto-extra-light text-xl w-[200px]">
              Bank / NBFC's
            </h1>
          </div>
